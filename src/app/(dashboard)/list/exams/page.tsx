...
const renderRow = (item: ExamList, role: UserRole | null) => {
  ...
  return (
    <tr
      key={item.id}
      className="hover:bg-eduspherePurpleLight even:bg-slate-50 border-gray-200 border-b text-sm"
    >
      ...
      {role === "student" && (
        <td className="py-4 pr-4 font-semibold text-eduspherePurpleDark text-left">
        ...
        <div className="flex items-center gap-2">
          {(role === "admin" || role === "teacher") && (
            <div className="flex items-center gap-2">
              <Link
                ...
                className="flex justify-center items-center bg-eduspherePurpleDark p-2 rounded-md text-white hover:scale-[1.05] transition"
          ...
          {(role === "admin" || role === "teacher") && (
            <Link
              ...
              className="bg-edusphereYellow hover:opacity-90 px-3 py-2 rounded-md text-xs hover:scale-[1.05] transition"
            >
              Submissions
            </Link>
          )}
            ...
            {(role === "admin" || role === "teacher") && (
              <>
                ...
                <Link
                  ...
                  className="bg-eduspherePurpleDark hover:opacity-90 px-4 py-2 rounded-md font-medium text-white text-sm transition-colors"
                >
                  {examT("addExam")}
                </Link>
              </>
