        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          {canManage && (
            <Link
              ...
              className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg bg-eduspherePurpleLight text-eduspherePurpleDark hover:brightness-95 transition-colors text-xs font-medium"
            >
