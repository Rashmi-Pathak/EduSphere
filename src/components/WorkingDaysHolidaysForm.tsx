    ...
    <div className="flex flex-col gap-6">
      <div className="space-y-4 bg-gray-50 p-6 rounded-xl">
            ...
            return (
              <button
                ...
                className={`px-3 py-2 border rounded-md text-sm font-medium transition-colors ${
                  isActive
                    ? "bg-eduspherePurpleLight border-eduspherePurpleDark text-eduspherePurpleDark"
        ...
        <button
          ...
          className="bg-eduspherePurpleDark disabled:opacity-60 hover:brightness-90 px-4 py-2 rounded-md font-semibold text-white text-sm transition-all"
        >
      ...
      <div className="flex flex-col gap-4 bg-gray-50 p-6 rounded-xl">
        <div className="flex justify-between items-center">
          ...
          <button
            ...
            className="bg-eduspherePurpleDark hover:brightness-90 px-4 py-2 rounded-md font-semibold text-white text-sm transition-all"
          >
            {t("addException")}
          </button>
        </div>
        ...
        >
          ...
          >
            ...
            <button
              ...
              className="bg-eduspherePurpleDark disabled:opacity-60 hover:brightness-90 mt-4 px-4 py-2 rounded-md w-fit font-semibold text-white text-sm transition-all"
            >
