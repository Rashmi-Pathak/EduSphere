...
import { useClerk } from "@/lib/clerk-mock-client";
    ...
    <div className="relative" ref={menuRef}>
      ...
      >
        {imageUrl ? (
          ...
          <span className="flex justify-center items-center bg-eduspherePurpleLight w-full h-full font-semibold text-eduspherePurpleDark text-xs">
            {initials}
          </span>
        )}
      </button>
