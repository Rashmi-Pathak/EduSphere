    ...
    <>
      <button
        ...
        className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg
                   bg-eduspherePurpleLight text-eduspherePurpleDark hover:brightness-95
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
          <div className="bg-white rounded-xl shadow-xl w-full max-w-lg mx-4 max-h-[85vh] flex flex-col">
            ...
            <div className="flex flex-wrap gap-3 px-6 py-3 border-b border-gray-100">
              ...
              <div className="flex items-center gap-2 px-3 py-1.5 bg-eduspherePurpleLight rounded-lg">
                <Award className="w-4 h-4 text-eduspherePurpleDark" />
                <span className="text-sm font-medium text-eduspherePurpleDark">
            ...
            <div className="flex-1 overflow-y-auto px-6 py-3">
              {loading ? (
                <div className="flex items-center justify-center py-10">
                  <div className="w-6 h-6 border-2 border-eduspherePurpleDark border-t-transparent rounded-full animate-spin" />
                </div>
                  ...
                  {submissions.map((s) => (
                    <li key={s.id} className="flex items-start gap-3 py-3">
                      ...
                      {s.student.img ? (
                        ...
                        <div className="w-8 h-8 rounded-full bg-eduspherePurpleLight flex items-center justify-center
                                        text-eduspherePurpleDark font-semibold text-xs flex-shrink-0 mt-0.5">
                          {s.student.name[0]}
                        </div>
                      )}
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-1.5 mt-1">
                          {s.score !== null ? (
                            <>
                              <span className="text-xs font-medium text-eduspherePurpleDark">
                                {s.score}/{maxScore}
                              </span>
                              <span
                      ...
                      <a
                        ...
                        className="flex-shrink-0 p-1.5 rounded-lg text-gray-400
                                   hover:text-eduspherePurpleDark hover:bg-eduspherePurpleLight transition-colors"
                      ...
                      >
                        ...
                        {s.score !== null && (
                          <span className="absolute top-0.5 right-0.5 w-1.5 h-1.5 rounded-full bg-eduspherePurpleDark" />
                        )}
                      </button>
            ...
            <div className="px-6 py-3 border-t border-gray-100">
              <button
                ...
                className="mb-2 w-full flex items-center justify-center gap-2 py-2 rounded-lg
                           bg-eduspherePurpleDark text-white disabled:opacity-50
        ...
        <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/40">
          <div className="bg-white rounded-xl shadow-xl p-6 w-full max-w-md mx-4">
            ...
            <input
              ...
              className="bg-white focus:bg-eduspherePurpleLight px-4 py-3 border-2 border-gray-200 focus:border-eduspherePurpleDark rounded-lg focus:outline-none focus:ring-0 w-full text-sm transition-all placeholder-gray-400"
            />
            ...
            <div className="flex gap-3 mt-4">
              ...
              <button
                ...
                className="flex-1 flex items-center justify-center gap-2
                           bg-eduspherePurpleDark hover:brightness-90 disabled:opacity-60
        ...
        <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/40">
          <div className="bg-white rounded-xl shadow-xl p-6 w-full max-w-md mx-4">
            ...
            <textarea
              ...
              className="bg-white focus:bg-eduspherePurpleLight px-4 py-3 border-2 border-gray-200 focus:border-eduspherePurpleDark rounded-lg focus:outline-none focus:ring-0 w-full text-sm transition-all placeholder-gray-400 resize-none"
            />
