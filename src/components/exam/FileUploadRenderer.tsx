      ...
      {uploadState.status === "uploading" && (
        <div className="space-y-2">
          <div className="flex items-center gap-2 text-sm text-gray-700">
            <Loader2 className="w-4 h-4 animate-spin text-eduspherePurpleDark" />
          ...
          <div className="w-full bg-gray-200 rounded-full h-2">
            <div
              className="bg-eduspherePurpleDark h-2 rounded-full transition-all duration-300"
            ...
            {!disabled && (
              <>
                <button
                  ...
                  className="flex items-center gap-1 text-xs text-eduspherePurpleDark hover:underline font-medium"
                >
      ...
      {uploadState.status === "error" && (
        <div className="flex items-start gap-3 bg-red-50 border border-red-200 rounded-md p-3">
          ...
          <button
            type="button"
            onClick={handleRetry}
            className="shrink-0 text-xs text-eduspherePurpleDark hover:underline font-medium"
          >
            {t("tryAgain")}
          </button>
        </div>
