        ...
        <div className="flex md:flex-row flex-col justify-between items-start md:items-center gap-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="bg-eduspherePurpleDark hover:bg-eduspherePurple disabled:opacity-50 px-6 py-2 rounded-md font-semibold text-white transition-colors"
            >
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
          <div className="w-full max-w-md rounded-lg bg-white shadow-xl">
            ...
            <div className="space-y-3 p-4">
              ...
              <p className="rounded-md bg-eduspherePurpleLight p-3 text-xs text-eduspherePurpleDark">
                {t("confirmNotice")}
              </p>
            </div>
