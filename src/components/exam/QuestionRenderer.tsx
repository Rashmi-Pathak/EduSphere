    ...
    <div className="w-full">
        ...
        <div className="flex gap-6">
          <label className="flex items-center gap-2 cursor-pointer">
            <input
              ...
              disabled={disabled}
              className="w-4 h-4 text-eduspherePurpleDark"
            />
      ...
      {question.type === "TEXT" && (
        <textarea
          ...
          disabled={disabled}
          className="p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-eduspherePurpleDark/50 w-full resize-y"
        />
      )}
