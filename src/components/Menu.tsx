...
import { useClerk, useUser } from "@/lib/clerk-mock-client";
import {
  BarChart3,
  BookOpen,
  Calendar,
            ...
            if (item.labelKey === "logout") {
              return (
                <button
                  ...
                  } items-center gap-4 hover:bg-eduspherePurple/35 disabled:opacity-70 md:px-2 py-2 rounded-md w-full text-gray-500 text-start transition-all duration-200 hover:translate-x-0.5 rtl:hover:-translate-x-0.5 active:scale-[0.98]`}
                >
                  <item.icon
                    size={20}
                    className="w-5 h-5 text-gray-500 group-hover:text-eduspherePurpleDark group-hover:scale-105 transition-all duration-200"
                  />

                  <span
                    className={`block text-gray-500 group-hover:text-eduspherePurpleDark transition-colors duration-200 ${
                      collapsed ? "lg:hidden" : ""
                    }`}
                  >
            ...
            return (
              <NavigationLink
                ...
                className={`
                  ...
                  ${
                    isActive
                      ? "bg-eduspherePurple/45 ring-1 ring-eduspherePurple/70"
                      : "text-gray-500 hover:bg-eduspherePurple/35 hover:translate-x-0.5 rtl:hover:-translate-x-0.5"
                  }
                `}
              >
                {isActive && (
                  <span className="hidden lg:block top-1 bottom-1 absolute bg-eduspherePurpleDark rounded-e w-1 start-0" />
                )}
                ...
                <item.icon
                  ...
                  className={`
                    ...
                    ${
                      isActive
                        ? "text-eduspherePurpleDark"
                        : "text-gray-500 group-hover:text-eduspherePurpleDark group-hover:scale-105"
                    }
                  `}
                />
                ...
                <span
                  className={`
                    ...
                    ${
                      isActive
                        ? "text-eduspherePurpleDark font-medium"
                        : "text-gray-500 group-hover:text-eduspherePurpleDark"
                    }
                  `}
                >
                  {label}
