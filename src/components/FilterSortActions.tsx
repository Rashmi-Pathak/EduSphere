    ...
    <div className="flex items-center gap-2">
      {filterKey && filterValue && (
        <button
          ...
          className="flex justify-center items-center bg-eduspherePurple hover:bg-eduspherePurpleDark rounded-md w-8 h-8 text-eduspherePurpleDark hover:text-eduspherePurple transition"
          title={t("filter")}
        >
