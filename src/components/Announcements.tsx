  ...
  return (
    <div className="bg-white p-4 rounded-md">
      ...
      <div className="flex flex-col gap-4 mt-4">
        {data[0] && (
          <div className="bg-edusphereSkyLight p-4 rounded-md">
            <div className="flex justify-between items-center">
        ...
        {data[1] && (
          <div className="bg-eduspherePurpleLight p-4 rounded-md">
            <div className="flex justify-between items-center">
        ...
        {data[2] && (
          <div className="bg-edusphereYellowLight p-4 rounded-md">
            <div className="flex justify-between items-center">
