  ...
  return (
    <div className="flex flex-col gap-4">
      <button
        ...
        className="group flex items-center gap-3 hover:bg-eduspherePurpleLight disabled:opacity-60 p-4 border-2 border-gray-300 hover:border-eduspherePurpleDark border-dashed rounded-lg transition-all cursor-pointer"
      >
        <Image
          src="/upload.png"
          alt=""
        ...
        <span className="inline-flex items-center gap-2 font-medium text-gray-700 text-sm">
          ...
          {uploadLabel}
          {isUploading && (
            <span className="font-semibold text-eduspherePurpleDark text-xs">
              {uploadProgress}%
            </span>
          )}
        </span>
      ...
      {isUploading && (
        <div className="space-y-1">
          ...
          <div className="bg-gray-200 rounded-full w-full h-2 overflow-hidden">
            <div
              className="bg-eduspherePurpleDark rounded-full h-full transition-all duration-200"
