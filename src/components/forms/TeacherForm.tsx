          ...
          <div className="flex flex-col gap-2 w-full">
            ...
            <div className="relative">
              <input
                ...
                {...register("password")}
                className="focus:bg-eduspherePurpleLight px-4 py-3 pe-10 border-2 border-gray-200 focus:border-eduspherePurpleDark rounded-lg focus:outline-none focus:ring-0 w-full text-sm transition-all placeholder-gray-400"
              />
              <button
                type="button"
                ...
                className="top-1/2 end-3 absolute text-gray-400 hover:text-eduspherePurpleDark transition-colors -translate-y-1/2"
              >
      ...
      <div className="space-y-4 bg-gray-50 p-6 rounded-xl">
        ...
        <div className="gap-4 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3">
          ...
          <div className="flex flex-col gap-2 w-full">
            ...
            <select
              className="bg-white focus:bg-eduspherePurpleLight px-4 py-3 border-2 border-gray-200 focus:border-eduspherePurpleDark rounded-lg focus:outline-none focus:ring-0 text-sm transition-all"
              {...register("sex")}
      ...
      <div className="space-y-4 bg-gray-50 p-6 rounded-xl">
        <div className="flex flex-col gap-3 w-full subject-search">
          <div className="flex justify-between items-end gap-4">
            ...
            <span className="bg-eduspherePurpleLight px-4 py-2 rounded-full font-semibold text-eduspherePurpleDark text-xs">
              {commonT("selected", {
          ...
          <div className="relative">
            <div className="flex items-center gap-2 bg-white focus-within:bg-eduspherePurpleLight px-4 py-3 border-2 border-gray-200 focus-within:border-eduspherePurpleDark rounded-lg focus-within:ring-0 transition-all">
              <input
                type="search"
                value={subjectSearch}
              ...
              <button
                ...
                className="text-gray-400 hover:text-eduspherePurpleDark transition-colors"
                aria-label={commonT("searchSubjects")}
              >
                ...
                {filteredSubjectOptions.length > 0 ? (
                  filteredSubjectOptions.map((subject) => (
                    <button
                      key={subject.id}
                      type="button"
                      className="hover:bg-eduspherePurpleLight px-4 py-3 w-full hover:text-eduspherePurpleDark text-sm text-start transition-colors"
                ...
                (pair: SubjectClassPair, index: number) => {
                  ...
                  return (
                    <div
                      ...
                      className="flex items-center gap-2 bg-eduspherePurpleLight px-4 py-2 rounded-full font-medium text-eduspherePurpleDark text-sm"
                    >
                      <span>{subject?.name ?? pair.subjectId}</span>
                      <button
                        type="button"
                        onClick={() => remove(index)}
                        className="text-eduspherePurpleDark hover:text-red-500 transition-colors"
