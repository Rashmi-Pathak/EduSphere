  ...
  return (
    ...
    >
      ...
      {(qType === "TEXT" || qType === "FILE") && (
        <div className="space-y-3 p-4 border border-gray-300 border-dashed rounded-md">
          ...
          <textarea
            ...
            className="p-3 border-2 border-gray-200 focus:border-eduspherePurpleDark rounded-lg focus:outline-none w-full min-h-[100px] text-sm transition-all"
      ...
      {qType === "FILE" && (
        <div className="space-y-4 p-4 border border-gray-300 border-dashed rounded-md">
          <div className="flex items-center gap-2">
            <FileText className="w-4 h-4 text-eduspherePurpleDark" />
            <h3 className="font-medium text-gray-700 text-sm">
              {t("fileSettings")}
            </h3>
          </div>
          ...
          <div className="space-y-2">
            ...
            <input
              type="text"
              className="p-2 border-2 border-gray-200 focus:border-eduspherePurpleDark rounded-lg focus:outline-none w-full text-sm transition-all"
          ...
          <div className="space-y-2">
            ...
            <textarea
              ...
              className="p-3 border-2 border-gray-200 focus:border-eduspherePurpleDark rounded-lg focus:outline-none w-full min-h-[60px] text-sm transition-all"
  ...
  return (
    <form className="flex flex-col gap-6" onSubmit={handleSubmit(onSubmit)}>
      <div className="gap-6 grid grid-cols-1 lg:grid-cols-2">
        <section className="space-y-4 bg-eduspherePurpleLight p-4 border border-eduspherePurpleDark/10 rounded-md">
      ...
      <section className="flex flex-col space-y-4 bg-eduspherePurpleLight p-4 border border-eduspherePurpleDark/10 rounded-md">
        ...
        <div className="flex flex-col gap-2 w-full">
          ...
          <textarea
            ...
            className="bg-white focus:bg-eduspherePurpleLight px-4 py-3 border-2 border-gray-200 focus:border-eduspherePurpleDark rounded-lg focus:outline-none focus:ring-0 w-full text-sm transition-all resize-none placeholder-gray-400"
          />
      ...
      <section className="flex flex-col space-y-4 bg-eduspherePurpleLight p-4 border border-eduspherePurpleDark/10 rounded-md">
        ...
        <button
          ...
          className="bg-eduspherePurpleDark disabled:opacity-60 hover:brightness-90 ms-auto px-4 py-2 rounded-md w-fit text-white transition-all"
        >
          {t("addQuestion")}
        </button>
      </section>
      ...
      <button
        ...
        className="bg-eduspherePurpleDark disabled:opacity-60 hover:brightness-90 px-4 py-2 rounded-md w-fit text-white transition-all"
      >
        {isSubmitting
          ? mode === "update"
            ? actionsT("updating")
