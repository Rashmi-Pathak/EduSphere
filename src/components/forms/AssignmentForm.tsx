    ...
    <form className="flex flex-col gap-6" onSubmit={onSubmit}>
        ...
        <div className="flex flex-col gap-2 w-full">
          ...
          {isSubjectLocked ? (
            ...
            <div className="relative">
              ...
              <div className="flex items-center gap-2 bg-white focus-within:bg-eduspherePurpleLight px-4 py-3 border-2 border-gray-200 focus-within:border-eduspherePurpleDark rounded-lg transition-all">
                        ...
                        return (
                          <button
                            ...
                            className={`px-4 py-3 w-full text-sm text-start transition-colors ${
                              isSelected
                                ? "bg-eduspherePurpleLight text-eduspherePurpleDark font-medium"
                                : "hover:bg-eduspherePurpleLight hover:text-eduspherePurpleDark"
                            }`}
                          >
                            {subject.name}
                          </button>
      ...
      <div className="flex flex-col gap-2">
        ...
        <textarea
          ...
          className="w-full min-h-[110px] rounded-lg border-2 border-gray-200 p-3 text-sm outline-none transition-all focus:border-eduspherePurpleDark focus:bg-eduspherePurpleLight"
        />
