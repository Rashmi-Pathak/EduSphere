        ...
        <>
          <div className="flex gap-3">
            <button
              ...
              className={`rounded-md px-4 py-2 text-sm border ${mode === "existing" ? "bg-edusphereSky border-edusphereSky" : "bg-white border-gray-300"}`}
            >
              {t("moveExisting")}
            </button>
            <button
              type="button"
              onClick={() => setMode("new")}
              className={`rounded-md px-4 py-2 text-sm border ${mode === "new" ? "bg-edusphereSky border-edusphereSky" : "bg-white border-gray-300"}`}
            >
              {t("createNew")}
            </button>
          </div>
