    ...
    if (existingSubmission && isOverdue && !allowLateSubmission) {
      return (
        <button
          ...
          className="flex items-center gap-1.5 bg-eduspherePurpleLight hover:brightness-95 px-2.5 py-1.5 rounded-lg font-medium text-eduspherePurpleDark text-xs transition-colors"
        >
        ...
        <div className="z-50 fixed inset-0 flex justify-center items-center bg-black/40">
          <div className="bg-white shadow-xl mx-4 p-6 rounded-xl w-full max-w-md">
              ...
              <div className="bg-gray-50 mb-4 p-3 border rounded-lg">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <a
                    ...
                    className="hover:opacity-80 text-eduspherePurpleDark"
                  >
            ...
            {existingSubmission?.gradePublished && existingSubmission.score !== null && existingSubmission.score !== undefined && (
              <div className="bg-eduspherePurpleLight mb-4 p-3 border border-eduspherePurpleDark/20 rounded-lg">
                <div className="flex items-center justify-between gap-3">
                  <p className="font-medium text-eduspherePurpleDark text-xs">
                    {t("modal.publishedGrade")}
                  </p>
                  <p className="font-semibold text-eduspherePurpleDark text-sm">
              ...
              <form ref={formRef} onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-3">
                    <label
                      ...
                      className="cursor-pointer rounded-lg bg-eduspherePurpleLight px-3 py-1.5 text-sm font-medium text-eduspherePurpleDark hover:brightness-95"
                    >
                      {t("modal.chooseFile")}
                    </label>
                ...
                <div className="flex gap-3 pt-2">
                  ...
                  <button
                    type="submit"
                    disabled={isPending}
                    className="flex flex-1 justify-center items-center gap-2 bg-eduspherePurpleDark disabled:opacity-60 hover:brightness-90 py-2 rounded-lg font-medium text-white text-sm"
                  >
                    {isPending ? (
                      <>
