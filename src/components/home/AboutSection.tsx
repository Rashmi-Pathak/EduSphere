    ...
    <section id="about" className="mx-auto px-6 py-20 max-w-6xl">
      ...
      <div className="gap-6 grid md:grid-cols-3 mt-14">
        {highlights.map((item) => (
          <article
            key={item.key}
            className="bg-eduspherePurpleDeep/65 p-6 border border-purple-200/25 rounded-xl text-center"
          >
            <div className="inline-flex justify-center items-center bg-eduspherePurple/10 mb-4 rounded-lg w-12 h-12 text-eduspherePurpleDark">
