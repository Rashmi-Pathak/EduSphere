        ...
        <div className="mx-auto px-12 lg:px-24 py-5">
          <div className="relative flex justify-between items-center">
            ...
            <div className="hidden lg:flex items-center gap-4">
              ...
              <Link
                href="/school-signup"
                className="bg-edusphereInk hover:bg-eduspherePurpleMuted hover:shadow-[0_10px_25px_rgba(124,58,237,0.35)] px-4 py-2 rounded-md font-medium text-white transition-all duration-300"
              >
                {t("signUp")}
              </Link>
            </div>
