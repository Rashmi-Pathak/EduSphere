    ...
    >
      ...
      <div className="z-10 relative mx-auto px-6 py-20 md:py-24 max-w-6xl text-center">
        ...
        <div className="flex justify-center gap-4 mt-10">
          <Link
            href="/sign-in"
            className="inline-flex justify-center items-center gap-2 bg-edusphereInk hover:bg-eduspherePurpleMuted hover:shadow-[0_8px_30px_rgba(124,58,237,0.35)] px-4 sm:px-7 py-2 sm:py-3 rounded-md font-medium text-white hover:scale-[1.03] active:scale-[0.98] transition-all duration-300"
          >
            {t("signIn")}
          ...
          <Link
            href="/school-signup"
            className="inline-flex justify-center items-center hover:bg-white/10 hover:shadow-[0_8px_25px_rgba(124,58,237,0.12)] px-4 sm:px-7 py-2 sm:py-3 border border-purple-200/25 hover:border-eduspherePurple/60 rounded-md font-medium text-white hover:scale-[1.03] active:scale-[0.98] transition-all duration-300"
          >
            {t("signUp")}
          </Link>
        </div>
