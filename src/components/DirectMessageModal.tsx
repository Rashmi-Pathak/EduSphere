    ...
    <div className="z-50 fixed inset-0 flex justify-center items-center bg-black bg-opacity-50">
      <div className="relative bg-white shadow-xl p-6 rounded-xl w-full max-w-xl">
        <button
          ...
          className="top-4 end-4 absolute text-gray-400 hover:text-eduspherePurpleDark transition-colors"
        >
          <X className="w-5 h-5" />
        </button>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-6">
            ...
            <div className="grid grid-cols-1 gap-4">
              <div className="flex flex-col gap-2 w-full">
                ...
                <input
                  ...
                  className="focus:bg-eduspherePurpleLight px-4 py-3 border-2 border-gray-200 focus:border-eduspherePurpleDark rounded-lg focus:outline-none focus:ring-0 w-full text-sm transition-all placeholder-gray-400"
              ...
              <div className="flex flex-col gap-2 w-full">
                ...
                <textarea
                  ...
                  className="bg-white focus:bg-eduspherePurpleLight px-4 py-3 border-2 border-gray-200 focus:border-eduspherePurpleDark rounded-lg focus:outline-none focus:ring-0 w-full text-sm transition-all resize-none"
          ...
          <div className="flex justify-end gap-3">
            ...
            <button
              ...
              className="bg-eduspherePurpleDark disabled:opacity-60 hover:brightness-90 px-6 py-2 rounded-lg font-semibold text-white text-sm transition-all"
            >
